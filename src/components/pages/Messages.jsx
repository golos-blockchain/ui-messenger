...
class Messages extends React.Component {
                    ...
                    <a href="#" onClick={e => e.preventDefault()}>
                        <div className='msgs-curruser-notify-sink' style={{ marginRight: '0.2rem' }}>
                            ...
                            <div className='TopRightMenu__notificounter'>
                                <NotifiCounter fields='mention,donate,send,receive,fill_order,delegate_vs,new_sponsor,sponsor_inactive' />
                            </div>
                        </div>
                    </a>
                </LinkWithDropdown>
    ...
    _renderMenuItems = (isSmall) => {
        ...
        let user_menu = [
            ...
            {link: walletLink, extLink: 'wallet', icon: 'new/wallet', value: tt('g.wallet'), addon: <NotifiCounter fields='send,receive,fill_order,delegate_vs' />},
