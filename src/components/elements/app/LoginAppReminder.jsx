...
class LoginAppReminder extends Component {
    ...
    render() {
        ...
        const msgsUrl = 'https://files.golos.app/api/exe/messenger/android/latest'
        ...
        return <div className='LoginAppReminder'>
            ...
            {showAndroid ?
                <div>
                    <a href={msgsUrl} target='_blank' rel='nofollow noreferrer' title={androidTitle}>
                        <QRCode text={msgsUrl} />
                        &nbsp;&nbsp;
                        {msgsUrl.replace('https://', '')}
                    </a>
                </div> : null}
        </div>
    }
